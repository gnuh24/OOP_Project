...
public class QLBienLai {
    ...
    public static void thongKeDoanhThuTheoChuongTrinh(LocalDate ngayBatDau, LocalDate ngayKetThuc) {
        double[] tongDoanhThu = new double[18];
        for (BienLai bienLai : QLBienLai.dsBienLai) {
            if((bienLai.getYeuCauDangKy().getTrangThaiDangKy()==TrangThaiDangKy.DA_GHI_DANH)
                    &&bienLai.getNgayThanhToan().toLocalDate().isAfter(ngayBatDau)
                    &&bienLai.getNgayThanhToan().toLocalDate().isBefore(ngayKetThuc)) {
                tongDoanhThu[0] += bienLai.getSoTienDaDong();
                switch (bienLai.getYeuCauDangKy().getLopHoc().getChuongTrinh().getMaChuongTrinh()) {
                    case "CTH001":
                        tongDoanhThu[1] += bienLai.getSoTienDaDong();
    ...
    public static void inTatCaBienLai(User user){
        for (BienLai bienLai:dsBienLai){
            if (bienLai.getYeuCauDangKy().getHocVien().getMaUser().equals(user.getMaUser())){
                bienLai.inBienLai();
            }
        }
    }

    public static void thongKeDoanhThuTheoKhoa(LocalDate ngayBatDau, LocalDate ngayKetThuc) {
        double tongDoanhThu = 0;
        double tongDoanhThuTheoLichSu = 0;
        System.out.println("*".repeat(50));
        System.out.printf("*  %-20s*  %-23s*\n","Khóa", "Doanh thu");
