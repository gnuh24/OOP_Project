...
public class QLChuongTrinhHoc {
    ...
    public static ArrayList<ChuongTrinhHoc> timKiemTheoTheLoai() {
        ...
        do{
            ...
            choice = ScannerUtils.inputInt("Bạn cần phải nhập đúng định dạng số nguyên !!");
    ...
    public static void xuLyDuLieu(ArrayList<String> duLieu) {
        ...
        for (String dong : duLieu) {
            ...
            int thoiLuong = Integer.valueOf(cacThuocTinh[4]);
            int hocPhi = Integer.valueOf(cacThuocTinh[5]);
