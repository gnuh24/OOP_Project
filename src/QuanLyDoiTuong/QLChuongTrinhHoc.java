...
public class QLChuongTrinhHoc {
    ...
    public static void inChuongTrinhHoc(ArrayList<ChuongTrinhHoc> dsChuongTrinhHoc) {
        System.out.printf(
                "*****************************************************************************************************************************\n");
        System.out.printf("* %-5s*   %-27s*   %-23s*   %-20s*   %-12s*   %-15s*\n", "Code", "Thể loại", "Trình độ",
                "Tên khóa học", "Thời lượng", "Học phí");
        System.out.printf(
                "*****************************************************************************************************************************\n");
        for (ChuongTrinhHoc i : dsChuongTrinhHoc) {
            System.out.printf("*  %-4s*   %-27s*   %-23s*   %-20s*   %-12d*   %-15d*\n", i.getMaChuongTrinh(),
                    i.getTheLoai(), i.getTrinhDo(), i.getKhoaHoc(), i.getThoiLuong(), i.getHocPhi());
        }
        System.out.printf(
                "*****************************************************************************************************************************\n");
    ...
    public static ArrayList<String> xuLyDuLieuDeLuu() {
        ...
        for (ChuongTrinhHoc chuongTrinhHoc : dsChuongTrinhHoc) {
            ...
            sb.append(chuongTrinhHoc.getMaChuongTrinh());
            sb.append("#");
            sb.append(chuongTrinhHoc.getTheLoai());
            sb.append("#");
            sb.append(chuongTrinhHoc.getTrinhDo());
            sb.append("#");
            sb.append(chuongTrinhHoc.getKhoaHoc());
            sb.append("#");
            sb.append(chuongTrinhHoc.getThoiLuong());
            sb.append("#");
            sb.append(chuongTrinhHoc.getHocPhi());
